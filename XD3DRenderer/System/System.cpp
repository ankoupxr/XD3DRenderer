...
MainWndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	...
	return System::GetEngineSingleton()->MsgProc(hwnd, msg, wParam, lParam);
}


System* System::EngineSingleton = nullptr;
System* System::GetEngineSingleton() 
{
...
HINSTANCE System::GetEngineInstHandle() const
{
...
void System::Update(const GameTimer& gt)
{
	//World->Update(Timer);
...
void System::EndFrame(const GameTimer& gt)
{
	//World->EndFrame(gt);
