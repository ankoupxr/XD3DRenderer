...
D3D12TextureRef D3D12RHI::CreateTexture(const TTextureInfo& TextureInfo, uint32_t CreateFlags, TVector4 RTVClearValue)
{
...
D3D12TextureRef D3D12RHI::CreateTexture(Microsoft::WRL::ComPtr<ID3D12Resource> D3DResource, TTextureInfo& TextureInfo, uint32_t CreateFlags)
{
	...
	TextureRef->ResourceLocation.SetType(D3D12ResourceLocation::EResourceLocationType::StandAlone);
...
D3D12TextureRef D3D12RHI::CreateTextureResource(const TTextureInfo& TextureInfo, uint32_t CreateFlags, TVector4 RTVClearValue)
{
	D3D12TextureRef TextureRef = std::make_shared<D3D12Texture>();
...
void  D3D12RHI::CreateTextureViews(D3D12TextureRef TextureRef, const TTextureInfo& TextureInfo, uint32_t CreateFlags)
{
	auto TextureResource = TextureRef->GetD3DResource();
